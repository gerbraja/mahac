...
Write-Host "Running python script test_forgot.py..."
$env:DATABASE_URL = $DB_URL
& "c:/Users/mahac/multinivel/tiendavirtual/.venv/Scripts/python.exe" "c:\Users\mahac\multinivel\tiendavirtual\miweb\CentroComercialTEI\backend\scripts\test_forgot.py"
