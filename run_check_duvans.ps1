...
$SCRIPT_PATH = "c:\Users\mahac\multinivel\tiendavirtual\miweb\CentroComercialTEI\backend\check_duvans.py"

Write-Host "Iniciando Cloud SQL Proxy..." -ForegroundColor Cyan
$proxy = Start-Process -FilePath $PROXY_PATH `
    -ArgumentList "tei-mlm-prod:us-central1:mlm-db-us --port=5432" `
...
Write-Host "Ejecutando script de chequeo..." -ForegroundColor Cyan
