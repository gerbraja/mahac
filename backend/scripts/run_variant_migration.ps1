...
Write-Host "Running Python Migration Script..."
$env:DATABASE_URL = $DB_URL
& "c:/Users/mahac/multinivel/tiendavirtual/.venv/Scripts/python.exe" "c:/Users/mahac/multinivel/tiendavirtual/miweb/CentroComercialTEI/backend/scripts/migrate_live_variants.py"
