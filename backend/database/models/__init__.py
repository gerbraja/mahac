...
from . import user, product, cart, supplier, order, order_item, payment_transaction, category, withdrawal, product_review, shipment_batch, pickup_point, compliance_record, merchant, allied_commerce
try:
...
try:
    from . import physical_transaction
except Exception:
    pass
