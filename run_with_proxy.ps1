# run_with_proxy.ps1
# Inicia Cloud SQL Proxy, espera, ejecuta el script Python, detiene el proxy
...
$SCRIPT_PATH = "c:\Users\mahac\multinivel\tiendavirtual\miweb\CentroComercialTEI\register_tejidos_fenix.py"

Write-Host "Iniciando Cloud SQL Proxy..." -ForegroundColor Cyan
$proxy = Start-Process -FilePath $PROXY_PATH `
    -ArgumentList "tuempresainternacional:us-central1:tiendavirtual --port=5432" `
