...
Write-Host "Waiting 8 seconds for proxy to start..."
Start-Sleep -Seconds 8

Write-Host "Running python script..."
$env:DATABASE_URL = $DB_URL
& "c:\Users\mahac\multinivel\tiendavirtual\miweb\CentroComercialTEI\.venv\Scripts\python.exe" "c:\Users\mahac\multinivel\tiendavirtual\miweb\CentroComercialTEI\backend\scripts\migrate_order_items.py"
